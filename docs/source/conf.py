...
# -*- coding: utf-8 -*-
#
# jetbot_widgets documentation build configuration file
#
...
_version_py = os.path.join(repo, 'jetbot_widgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jetbot_widgetsdoc'
...
latex_documents = [
    (master_doc, 'jetbot_widgets.tex', 'jetbot_widgets Documentation',
     'John Welsh', 'manual'),
]
